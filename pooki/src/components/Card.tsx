...
import { PokemonDType } from "./types";
    ...
    >
      <div className="rounded-lg  h-[40%] flex items-center justify-center p-24 ">
        <Image
          ...
          src={`https://raw.githubusercontent.com/HybridShivam/Pokemon/master/assets/images/${pookieData.id.toString().padStart(3, "0")}.png`}
          height={200}
          width={200}
          alt=""
        />
      ...
      <div className=" p-2  pt-3 w-full h-[60%] ">
        <h1 className={cn("text-2xl capitalize", space_grotesk.className)}>
          {pookieData.name}
        </h1>
          ...
          {pookieData.stats.map(({ stat, base_stat }) => (
            <div className="mb-1" key={stat.name}>
              ...
              <div className="h-0.5 w-full bg-white/5">
                <div
                  className="bg-gradient-to-r from-neutral-500 via-neutral-300 via-[80%] to-neutral-100 h-full"
